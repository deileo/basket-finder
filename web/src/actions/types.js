...
export const JOIN_EVENT_ERROR = 'event_join_error';
...
export const JOIN_EVENT_MODAL_OPENED = 'join_event_modal_opened';
export const JOIN_EVENT_MODAL_CLOSED = 'join_event_modal_closed';
